...
indeed, only a much smaller amount of addition manual work is required compared to EasyCrypt. We now review EasyCrypt in Section~\ref{sec:easycrypt} and then present our approach, findings and our new tool SSBee in Section~\ref{sec:ssbee} where we also compare to EasyCrypt.
