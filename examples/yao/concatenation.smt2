      ...
      (ite
        ...
        (let
          (
            ...
            (K (return-Left-keys_top-GETKEYSIN-value __ret)))
          (let
            ((r (__sample-rand-Left-Bits_n 2 (composition-rand-Left-2 __global_state))))
            (let
              (
                (__global_state
                  (mk-composition-state-Left
          ...
          (let
            ...
            (let
              ...
              (let
                ((br false))
                (let
                  ((unwrap-1 (maybe-get op)))
                  (let
                    ((bj unwrap-1))
                    (let
                      ((unwrap-2 (maybe-get Z)))
                      (let
                        ((kzero unwrap-2))
                        (let
                          (
                            (__ret
                              (oracle-Left-enc-ENCN
                                ...
                                bl
                                kzero
                                (state-Left-gate-zeron __self_state))))
                          (ite
                                        ...
                                        (let
                                          ...
                                          (let
                                            (
                                              (C
                                                (
                                                  (as const (Array Bits_p (Maybe (Maybe Bool))))
                                                  (as mk-none (Maybe (Maybe Bool))))))
                                            (let
                                              ...
                                              (let
                                                ...
                                                (let
                                                  ((br false))
                                                  (let
                                                    ((unwrap-3 (maybe-get op)))
                                                    (let
                                                      ((bj unwrap-3))
                                                      (let
                                                        ((unwrap-4 (maybe-get Z)))
                                                        (let
                                                          ((kzero unwrap-4))
                                                          (let
                                                            (
                                                                              ...
                                                                              (let
                                                                                ...
                                                                                (let
                                                                                  ...
                                                                                  (let
                                                                                    ((br true))
                                                                                    (let
                                                                                      ((unwrap-5 (maybe-get op)))
                                                                                      (let
                                                                                        ((bj unwrap-5))
                                                                                        (let
                                                                                          ((unwrap-6 (maybe-get Z)))
                                                                                          (let
                                                                                            ((kzero unwrap-6))
                                                                                            (let
                                                                                              (
                                                                                                                ...
                                                                                                                (let
                                                                                                                  ...
                                                                                                                  (let
                                                                                                                    ...
                                                                                                                    (let
                                                                                                                      ((br true))
                                                                                                                      (let
                                                                                                                        ((unwrap-7 (maybe-get op)))
                                                                                                                        (let
                                                                                                                          ((bj unwrap-7))
                                                                                                                          (let
                                                                                                                            ((unwrap-8 (maybe-get Z)))
                                                                                                                            (let
                                                                                                                              ((kzero unwrap-8))
                                                                                                                              (let
                                                                                                                                (
                      ...
                      (let
                        ...
                        (let
                          (
                            (Sl
                              (
                                (as const (Array Bool (Maybe (Maybe Bits_n))))
                                (as mk-none (Maybe (Maybe Bits_n))))))
                          (let
                                                                  ...
                                                                  (let
                                                                    ...
                                                                    (let
                                                                      ...
                                                                      (let
                                                                        ((dr false))
                                                                        (let
                                                                          ((unwrap-1 (maybe-get Sl)))
                                                                          (let
                                                                            ((kl unwrap-1))
                                                                            (let
                                                                              ((unwrap-2 (maybe-get Sr)))
                                                                              (let
                                                                                ((kr unwrap-2))
                                                                                (let
                                                                                  ((kj (state-Right-simgate-zeron __self_state)))
                                                                                  (ite
                                                                                    (and (or (not dl)) (or (not dr)))
                                                                                    (let
                                                                                      ((unwrap-3 (maybe-get Sj)))
                                                                                      (let
                                                                                        ((kj unwrap-3))
                                                                                        (let
                                                                                          (
                                                                                            (rin (__sample-rand-Right-Bits_n 1 (composition-rand-Right-1 __global_state))))
                                                                                          (let
                                                                                            (
                                                                                              (__global_state
                                                                                                (mk-composition-state-Right
                                                                                            ...
                                                                                            (let
                                                                                              (
                                                                                                (rout (__sample-rand-Right-Bits_n 2 (composition-rand-Right-2 __global_state))))
                                                                                              (let
                                                                                                (
                                                                                                  (__global_state
                                                                                                    (mk-composition-state-Right
                                                                                                      ...
                                                                                                      (let
                                                                                                        ...
                                                                                                        (let
                                                                                                          ...
                                                                                                          (let
                                                                                                            ((dr false))
                                                                                                            (let
                                                                                                              ((unwrap-4 (maybe-get Sl)))
                                                                                                              (let
                                                                                                                ((kl unwrap-4))
                                                                                                                (let
                                                                                                                  ((unwrap-5 (maybe-get Sr)))
                                                                                                                  (let
                                                                                                                    ((kr unwrap-5))
                                                                                                                    (let
                                                                                                                      ((kj (state-Right-simgate-zeron __self_state)))
                                                                                                                      (ite
                                                                                                                        (and (or (not dl)) (or (not dr)))
                                                                                                                        (let
                                                                                                                          ((unwrap-6 (maybe-get Sj)))
                                                                                                                          (let
                                                                                                                            ((kj unwrap-6))
                                                                                                                            (let
                                                                                                                              (
                                                                                                                                (rin (__sample-rand-Right-Bits_n 3 (composition-rand-Right-3 __global_state))))
                                                                                                                              (let
                                                                                                                                (
                                                                                                                                  (__global_state
                                                                                                                                    (mk-composition-state-Right
                                                                                                                                ...
                                                                                                                                (let
                                                                                                                                  (
                                                                                                                                    (rout (__sample-rand-Right-Bits_n 4 (composition-rand-Right-4 __global_state))))
                                                                                                                                  (let
                                                                                                                                    (
                                                                                                                                      (__global_state
                                                                                                                                        (mk-composition-state-Right
                                                                                                                                          ...
                                                                                                                                          (let
                                                                                                                                            ...
                                                                                                                                            (let
                                                                                                                                              ...
                                                                                                                                              (let
                                                                                                                                                ((dr true))
                                                                                                                                                (let
                                                                                                                                                  ((unwrap-7 (maybe-get Sl)))
                                                                                                                                                  (let
                                                                                                                                                    ((kl unwrap-7))
                                                                                                                                                    (let
                                                                                                                                                      ((unwrap-8 (maybe-get Sr)))
                                                                                                                                                      (let
                                                                                                                                                        ((kr unwrap-8))
                                                                                                                                                        (let
                                                                                                                                                          ((kj (state-Right-simgate-zeron __self_state)))
                                                                                                                                                                              ...
                                                                                                                                                                              (let
                                                                                                                                                                                ...
                                                                                                                                                                                (let
                                                                                                                                                                                  ...
                                                                                                                                                                                  (let
                                                                                                                                                                                    ((dr true))
                                                                                                                                                                                    (let
                                                                                                                                                                                      ((unwrap-10 (maybe-get Sl)))
                                                                                                                                                                                      (let
                                                                                                                                                                                        ((kl unwrap-10))
                                                                                                                                                                                        (let
                                                                                                                                                                                          ((unwrap-11 (maybe-get Sr)))
                                                                                                                                                                                          (let
                                                                                                                                                                                            ((kr unwrap-11))
                                                                                                                                                                                            (let
                                                                                                                                                                                              ((kj (state-Right-simgate-zeron __self_state)))
