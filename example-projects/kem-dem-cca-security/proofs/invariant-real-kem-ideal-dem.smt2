...
(define-fun invariant
    (
        (state-left <GameState_MonolithicPkeCcaGame_<$<!true!>$>>) ; left
        (state-right <GameState_ModularPkeCcaGame_<$<!false!><!true!>$>>) ; right
    )
    Bool
    (let
        (
            (left_pk (<pkg-state-MON_CCA-<$<!b!>$>-pk> (<game-MonolithicPkeCcaGame-<$<!true!>$>-pkgstate-pkg_MON_CCA> state-left)))
            (left_sk (<pkg-state-MON_CCA-<$<!b!>$>-sk> (<game-MonolithicPkeCcaGame-<$<!true!>$>-pkgstate-pkg_MON_CCA> state-left)))
            (right_pk_mod_cca (<pkg-state-MOD_CCA-<$$>-pk> (<game-ModularPkeCcaGame-<$<!false!><!true!>$>-pkgstate-pkg_MOD_CCA> state-right)))
            (right_pk_kem (<pkg-state-KEM-<$$>-pk> (<game-ModularPkeCcaGame-<$<!false!><!true!>$>-pkgstate-pkg_KEM> state-right)))
            (left_c (<pkg-state-MON_CCA-<$<!b!>$>-c> (<game-MonolithicPkeCcaGame-<$<!true!>$>-pkgstate-pkg_MON_CCA> state-left)))
            (right_c (<pkg-state-MOD_CCA-<$$>-c> (<game-ModularPkeCcaGame-<$<!false!><!true!>$>-pkgstate-pkg_MOD_CCA> state-right)))
            (right_kem_ek (<pkg-state-KEM-<$$>-ek> (<game-ModularPkeCcaGame-<$<!false!><!true!>$>-pkgstate-pkg_KEM> state-right)))
            (right_mod_cca_ek (<pkg-state-MOD_CCA-<$$>-ek> (<game-ModularPkeCcaGame-<$<!false!><!true!>$>-pkgstate-pkg_MOD_CCA> state-right)))
            (right_dem_c (<pkg-state-MOD_CCA-<$$>-em> (<game-ModularPkeCcaGame-<$<!false!><!true!>$>-pkgstate-pkg_MOD_CCA> state-right)))
            (right_key_k (<pkg-state-Key-<$<!key_idealization!>$>-k> (<game-ModularPkeCcaGame-<$<!false!><!true!>$>-pkgstate-pkg_Key> state-right)))
            (right_sk (<pkg-state-KEM-<$$>-sk> (<game-ModularPkeCcaGame-<$<!false!><!true!>$>-pkgstate-pkg_KEM> state-right)))
            (right_encaps_randomness (<pkg-state-KEM-<$$>-encaps_randomness> (<game-ModularPkeCcaGame-<$<!false!><!true!>$>-pkgstate-pkg_KEM> state-right)))
            (right_T (<pkg-state-DEM-<$<!dem_idealization!>$>-T> (<game-ModularPkeCcaGame-<$<!false!><!true!>$>-pkgstate-pkg_DEM> state-right)))
        )
        (and
...
(define-fun <relation-lemma-kem-correctness-monolithic_pke_cca_ideal_game-modular_pke_cca_game_with_real_kem_and_ideal_dem-PKDEC>
    (
        (old-state-left <GameState_MonolithicPkeCcaGame_<$<!true!>$>>)
        (old-state-right <GameState_ModularPkeCcaGame_<$<!false!><!true!>$>>)
        (return-left <OracleReturn-MonolithicPkeCcaGame-<$<!true!>$>-MON_CCA-<$<!b!>$>-PKDEC>)
        (return-right <OracleReturn-ModularPkeCcaGame-<$<!false!><!true!>$>-MOD_CCA-<$$>-PKDEC>)
        (ek_ctxt (Tuple2 Bits_400 Bits_*))
    )
    Bool
    (let
        (
            (pk (<pkg-state-KEM-<$$>-pk> (<game-ModularPkeCcaGame-<$<!false!><!true!>$>-pkgstate-pkg_KEM> old-state-right)))
            (sk (<pkg-state-KEM-<$$>-sk> (<game-ModularPkeCcaGame-<$<!false!><!true!>$>-pkgstate-pkg_KEM> old-state-right)))
        )
        (=>
            (not ((_ is mk-none) pk))
            (forall 
...
(define-fun <relation-lemma-rand-is-eq-monolithic_pke_cca_ideal_game-modular_pke_cca_game_with_real_kem_and_ideal_dem-PKENC>
    (
        (old-state-left <GameState_MonolithicPkeCcaGame_<$<!true!>$>>)
        (old-state-right <GameState_ModularPkeCcaGame_<$<!false!><!true!>$>>)
        (return-left <OracleReturn-MonolithicPkeCcaGame-<$<!true!>$>-MON_CCA-<$<!b!>$>-PKENC>)
        (return-right <OracleReturn-ModularPkeCcaGame-<$<!false!><!true!>$>-MOD_CCA-<$$>-PKENC>)
        (m Bits_*)
    )
    Bool 
    (and
        (rand-is-eq 2 1 (<game-MonolithicPkeCcaGame-<$<!true!>$>-rand-2> old-state-left) (<game-ModularPkeCcaGame-<$<!false!><!true!>$>-rand-1> old-state-right))
        (rand-is-eq 1 3 (<game-MonolithicPkeCcaGame-<$<!true!>$>-rand-1> old-state-left) (<game-ModularPkeCcaGame-<$<!false!><!true!>$>-rand-3> old-state-right))
    )
)