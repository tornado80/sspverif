...
(define-fun log_inverse_level_zero_and_non_zero
    (
        (log_inverse_level_zero (Maybe Bits_*))
        (log_inverse_level_non_zero (Maybe Bits_*))
        (log_inverse_psk (Maybe Bits_*))
    )
    Bool
    ; LogInverseDishonestLevelZero[k] = None and LogInverseDishonestLevelNonZero[k] = None => LogInverseDishonest[(psk, k)] = None
    ...
    ; LogInverseDishonestLevelZero[k] != None and LogInverseDishonestLevelNonZero[k] != None => LogInverseDishonestLevelNonZero[k] = LogInverseDishonest[(psk, k)] or LogInverseDishonestLevelZero[k] = LogInverseDishonest[(psk, k)]
    true
)
(define-fun invariant-log-inverse
    ...
    Bool
    ; Inverse maps
    ; LogInverseDishonest[(n, k)] = None => forall h: Log[(n, h)] != (_, 0, k)
    ; LogInverseDishonestLevelZero[k] = None and LogInverseDishonestLevelNonZero[k] = None => LogInverseDishonest[(psk, k)] = None
    ; LogInverseDishonestLevelZero[k] != None and LogInverseDishonestLevelNonZero[k] = None => LogInverseDishonestLevelZero[k] = LogInverseDishonest[(psk, k)]
    ; LogInverseDishonestLevelZero[k] = None and LogInverseDishonestLevelNonZero[k] != None => LogInverseDishonestLevelNonZero[k] = LogInverseDishonest[(psk, k)]
    ; LogInverseDishonestLevelZero[k] != None and LogInverseDishonestLevelNonZero[k] != None => LogInverseDishonestLevelNonZero[k] = LogInverseDishonest[(psk, k)] or LogInverseDishonestLevelZero[k] = LogInverseDishonest[(psk, k)]
    ; Log[psk, LogInverseDishonestLevelZero[k]] = (LogInverseDishonest[(psk, k)], 0, k) and level(LogInverseDishonestLevelZero[k]) = 0
    ; Log[psk, LogInverseDishonestLevelNonZero[k]] = (LogInverseDishonest[(psk, k)], 0, k) and level(LogInverseDishonestLevelZero[k]) != 0
    ; Log[n, LogInverseDishonest[(n, k)]] = (LogInverseDishonest[(n, k)], 0, k)
    (let
        (
            (Log_left (<pkg-state-Log-<$$>-Log> (<game-Gks0-<$$>-pkgstate-pkg_Log> state-Gks0)))
            (Log_right (<pkg-state-Log-<$$>-Log> (<game-Gks0Map-<$$>-pkgstate-pkg_Log> state-Gks0Map)))
        ...
        (forall
            ...
            (let 
                (
                    ...
                    (log_inverse_psk_left (select LogInverseDishonest_left (mk-tuple2 KEY_psk k)))
                    (log_inverse_psk_right (select LogInverseDishonest_right (mk-tuple2 KEY_psk k)))
                ...
                (and
                    (log_inverse_level_zero_and_non_zero log_inverse_level_zero_left log_inverse_level_non_zero_left log_inverse_psk_left)
                    (log_inverse_level_zero_and_non_zero log_inverse_level_zero_right log_inverse_level_non_zero_right log_inverse_psk_right)
                    (log_inverse_level_zero_invariant Log_left log_inverse_level_zero_left log_inverse_psk_left k)
                    (log_inverse_level_zero_invariant Log_right log_inverse_level_zero_right log_inverse_psk_right k)
                    (log_inverse_level_non_zero_invariant Log_left log_inverse_level_non_zero_left log_inverse_psk_left k)
                    (log_inverse_level_non_zero_invariant Log_right log_inverse_level_non_zero_right log_inverse_psk_right k)
