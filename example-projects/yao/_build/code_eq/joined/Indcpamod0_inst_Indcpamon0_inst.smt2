...
(assert (= randctr-Indcpamod0_inst-1 (composition-rand-Indcpamod0-1 game-state-Indcpamod0_inst-old)
)
)
...
(assert (= randctr-Indcpamod0_inst-2 (composition-rand-Indcpamod0-2 game-state-Indcpamod0_inst-old)
)
)
...
(assert (= randctr-Indcpamod0_inst-3 (composition-rand-Indcpamod0-3 game-state-Indcpamod0_inst-old)
)
)
...
(assert (= randctr-Indcpamod0_inst-4 (composition-rand-Indcpamod0-4 game-state-Indcpamod0_inst-old)
)
)
...
(assert (= randctr-Indcpamod0_inst-5 (composition-rand-Indcpamod0-5 game-state-Indcpamod0_inst-old)
)
)
...
(assert (= randctr-Indcpamod0_inst-6 (composition-rand-Indcpamod0-6 game-state-Indcpamod0_inst-old)
)
)
...
(assert (= randctr-Indcpamon0_inst-1 (composition-rand-Indcpamon0-1 game-state-Indcpamon0_inst-old)
)
)
...
(assert (= randctr-Indcpamon0_inst-2 (composition-rand-Indcpamon0-2 game-state-Indcpamon0_inst-old)
)
)
...
(assert (= randctr-Indcpamon0_inst-3 (composition-rand-Indcpamon0-3 game-state-Indcpamon0_inst-old)
)
)
...
(assert (= randctr-Indcpamon0_inst-4 (composition-rand-Indcpamon0-4 game-state-Indcpamon0_inst-old)
)
)
...
(assert (= randctr-Indcpamon0_inst-5 (composition-rand-Indcpamon0-5 game-state-Indcpamon0_inst-old)
)
)
...
(assert (= randctr-Indcpamon0_inst-6 (composition-rand-Indcpamon0-6 game-state-Indcpamon0_inst-old)
)
)
...
=======
>>>>>>> bc01bad (move Resolver and SliceResolver to utils::resolver, minor cleanup)
