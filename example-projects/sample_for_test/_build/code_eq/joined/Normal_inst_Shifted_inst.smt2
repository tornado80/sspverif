...
(declare-datatype IntermediateState_Normal ((mk-intermediate-state-Normal-0..1_ForStepi/0..2_Plain (intermediate-state-Normal-0..1_ForStepi/0..2_Plain-local-rand Bits_n)
 (intermediate-state-Normal-0..1_ForStepi/0..2_Plain-parent IntermediateState_Normal)
)
 (mk-intermediate-state-Normal-none)
)
)
(declare-datatype IntermediateState_Shifted ((mk-intermediate-state-Shifted-0..1_Plain (intermediate-state-Shifted-0..1_Plain-local-rand Bits_n)
 (intermediate-state-Shifted-0..1_Plain-parent IntermediateState_Shifted)
)
 (mk-intermediate-state-Shifted-1..2_ForStepi/0..2_Plain (intermediate-state-Shifted-1..2_ForStepi/0..2_Plain-local-rand Bits_n)
 (intermediate-state-Shifted-1..2_ForStepi/0..2_Plain-parent IntermediateState_Shifted)
)
...
(declare-datatype IntermediateState_Normal_pkg-Eval ((mk-intermediate-state-Normal-pkg-Eval-0..1_ForStepi/0..2_Plain (intermediate-state-Normal-pkg-Eval-0..1_ForStepi/0..2_Plain-local-rand Bits_n)
)
 (mk-intermediate-state-Normal-pkg-Eval-end)
 (mk-intermediate-state-Normal-pkg-Eval-begin)
 (mk-intermediate-state-Normal-pkg-Eval-end (intermediate-state-Normal-pkg-Eval-end-return_value Return-Normal-pkg-Eval)
)
)
)
(define-fun oracle-Normal-pkg-Eval ((__game_state CompositionState-Normal)
 (__intermediate_state IntermediateState-Normal-pkg-Eval)
)
 PartialReturn-Normal-pkg-Eval (match partial-arg:intermediate-state (((mk-intermediate-state-Normal-pkg-Eval-0..1_ForStepi/0..2_Plain match-local-rand)
 (oracle-Normal-pkg-0..1_ForStepi/0..2_Plain match-local-rand)
)
 ((mk-intermediate-state-Normal-pkg-Eval-end)
 src/writers/smt/partials.rs: -- search for kdsfjlsdjf -- TODO add partial return)
)
)
)
