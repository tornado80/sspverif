...
(declare-fun __sample-rand-Normal-Bits_n (Int Int)
 Bits_n)
(declare-datatype IntermediateOracleState_Normal_pkg_pkg!Eval!Step0..1/pkg!Eval!Plain0..2 ((oracle-intermediate-state-return_Normal_pkg_pkg!Eval!Step0..1/pkg!Eval!Plain0..2_2 (oracle-intermediate-state-return_Normal_pkg_pkg!Eval!Step0..1/pkg!Eval!Plain0..2_2_rand Bits_n)
 (oracle-intermediate-state-return_Normal_pkg_pkg!Eval!Step0..1/pkg!Eval!Plain0..2_2_T (Array Int (Maybe Bits_n)
)
)
)
)
...
(declare-datatype IntermediatePackageInstanceState_Normal_pkg ((no-intermediate-package-instance-state_Normal_pkg)
 (intermediate-package-instance-state_Normal_pkg_pkg!Eval!Step0..1/pkg!Eval!Plain0..2 (intermediate-package-instance-state-get_Normal_pkg_pkg!Eval!Step0..1/pkg!Eval!Plain0..2 IntermediateOracleState_Normal_pkg_pkg!Eval!Step0..1/pkg!Eval!Plain0..2)
)
)
)
...
(declare-datatype Return_Normal_pkg_pkg!Eval!Step0..1/pkg!Eval!Plain0..2 ((mk-return-Normal-pkg-pkg!Eval!Step0..1/pkg!Eval!Plain0..2 (return-Normal-pkg-pkg!Eval!Step0..1/pkg!Eval!Plain0..2-state (Array Int CompositionState-Normal)
)
 (return-Normal-pkg-pkg!Eval!Step0..1/pkg!Eval!Plain0..2-state-length Int)
 (return-Normal-pkg-pkg!Eval!Step0..1/pkg!Eval!Plain0..2-value (Maybe Empty)
)
 (return-Normal-pkg-pkg!Eval!Step0..1/pkg!Eval!Plain0..2-is-abort Bool)
)
)
)
; Composition of Normal
(define-fun oracle-Normal-pkg-pkg!Eval!Step0..1/pkg!Eval!Plain0..2 ((__global_state (Array Int CompositionState-Normal)
)
 (__state_length Int)
)
 Return_Normal_pkg_pkg!Eval!Step0..1/pkg!Eval!Plain0..2 (let ((__self_state (composition-pkgstate-Normal-pkg (select __global_state __state_length)
)
)
)
 ...
 (mk-return-Normal-pkg-pkg!Eval!Step0..1/pkg!Eval!Plain0..2 __global_state __state_length (mk-some mk-empty)
 false)
)
)
)
...
(declare-fun __sample-rand-Shifted-Bits_n (Int Int)
 Bits_n)
(declare-datatype IntermediateOracleState_Shifted_pkg_pkg!Eval!Plain0..1 ((oracle-intermediate-state-return_Shifted_pkg_pkg!Eval!Plain0..1_1 (oracle-intermediate-state-return_Shifted_pkg_pkg!Eval!Plain0..1_1_rand Bits_n)
)
)
)
(