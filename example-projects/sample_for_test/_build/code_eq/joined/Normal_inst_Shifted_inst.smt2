...
(declare-datatype IntermediateState_Normal ((mk-intermediate-state-Normal-pkg!Eval!ForStepi0..1/pkg!Eval!Plain0..2 (intermediate-state-Normal-pkg!Eval!ForStepi0..1/pkg!Eval!Plain0..2-local-rand Bits_n)
 (intermediate-state-Normal-pkg!Eval!ForStepi0..1/pkg!Eval!Plain0..2-parent IntermediateState_Normal)
)
 (mk-intermediate-state-Normal-none)
)
)
(declare-datatype IntermediateState_Shifted ((mk-intermediate-state-Shifted-pkg!Eval!Plain0..1 (intermediate-state-Shifted-pkg!Eval!Plain0..1-local-rand Bits_n)
 (intermediate-state-Shifted-pkg!Eval!Plain0..1-parent IntermediateState_Shifted)
)
 (mk-intermediate-state-Shifted-pkg!Eval!ForStepi1..2/pkg!Eval!Plain0..2 (intermediate-state-Shifted-pkg!Eval!ForStepi1..2/pkg!Eval!Plain0..2-local-rand Bits_n)
 (intermediate-state-Shifted-pkg!Eval!ForStepi1..2/pkg!Eval!Plain0..2-parent IntermediateState_Shifted)
)
 (mk-intermediate-state-Shifted-none)
)
)
...
(define-fun oracle-Shifted-pkg-pkg!Eval!Plain0..1 ((__global_state (Array Int CompositionState-Shifted)
 ...
 (let ((__global_state (store __global_state (+ 1 __state_length)
 (mk-composition-state-Shifted (composition-pkgstate-Shifted-pkg (mk-composition-state-Shifted __self_state (composition-param-Shifted-m (select __global_state __state_length)
)
 (composition-param-Shifted-n (select __global_state __state_length)
)
 (composition-rand-Shifted-0 (select __global_state __state_length)
 ...
 (composition-param-Shifted-m (mk-composition-state-Shifted __self_state (composition-param-Shifted-m (select __global_state __state_length)
)
 (composition-param-Shifted-n (select __global_state __state_length)
)
 (composition-rand-Shifted-0 (select __global_state __state_length)
 ...
 (composition-param-Shifted-n (mk-composition-state-Shifted __self_state (composition-param-Shifted-m (select __global_state __state_length)
)
 (composition-param-Shifted-n (select __global_state __state_length)
)
 (composition-rand-Shifted-0 (select __global_state __state_length)
 ...
 (composition-rand-Shifted-0 (mk-composition-state-Shifted __self_state (composition-param-Shifted-m (select __global_state __state_length)
)
 (composition-param-Shifted-n (select __global_state __state_length)
)
 (composition-rand-Shifted-0 (select __global_state __state_length)
 ...
 (composition-rand-Shifted-1 (mk-composition-state-Shifted __self_state (composition-param-Shifted-m (select __global_state __state_length)
)
 (composition-param-Shifted-n (select __global_state __state_length)
)
 (composition-rand-Shifted-0 (select __global_state __state_length)
 ...
 (composition-rand-Shifted-2 (mk-composition-state-Shifted __self_state (composition-param-Shifted-m (select __global_state __state_length)
)
 (composition-param-Shifted-n (select __global_state __state_length)
)
 (composition-rand-Shifted-0 (select __global_state __state_length)
 ...
 (mk-intermediate-state-Shifted-pkg!Eval!ForStepi1..2/pkg!Eval!Plain0..2 rand )
)
)
)
 (__state_length (+ 1 __state_length)
