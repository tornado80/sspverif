...
(declare-datatype IntermediateState-Normal-pkg-Eval ((mk-intermediate-state-Normal-pkg-Eval-0..1_ForStepi/0..2_Plain (intermediate-state-Normal-pkg-Eval-0..1_ForStepi/0..2_Plain-local-rand Bits_n)
)
 (mk-intermediate-state-Normal-pkg-Eval-begin)
 (mk-intermediate-state-Normal-pkg-Eval-end (intermediate-state-Normal-pkg-Eval-end-return_value Empty)
)
)
)
(declare-datatype PartialReturn-Normal-pkg-Eval ((mk-partial-return-Normal-pkg-Eval (partial-return-Normal-pkg-Eval-gamestate CompositionState-Normal)
 (partial-return-Normal-pkg-Eval-intermediate_state IntermediateState-Normal-pkg-Eval)
)
)
)
(define-fun oracle-Normal-pkg-Eval-0..1_ForStepi/0..2_Plain ((__global_state CompositionState-Normal)
 ...
 PartialReturn-Normal-pkg-Eval (let ((__self_state __global_state)
)
 (let ((rand (__sample-rand-Normal-Bits_n 1 (composition-rand-Normal-1 __global_state)
)
)
)
 (let ((__global_state (store __global_state __state_length (mk-composition-state-Normal (composition-pkgstate-Normal-pkg __global_state)
 ...
 (composition-intermediate-state-Normal __global_state)
)
)
)
)
 ...
 (todo_build_innermost_split_empty_return)
)
)
)
)
...
(define-fun oracle-Normal-pkg-Eval ((__game_state CompositionState-Normal)
 ...
 PartialReturn-Normal-pkg-Eval (match __intermediate_state (((mk-intermediate-state-Normal-pkg-Eval-0..1_ForStepi/0..2_Plain match-local-rand)
 (oracle-Normal-pkg-Eval-0..1_ForStepi/0..2_Plain match-local-rand)
)
)
)
)
