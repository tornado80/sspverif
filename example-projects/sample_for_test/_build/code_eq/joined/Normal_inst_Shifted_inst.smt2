...
(declare-fun __sample-rand-Normal-Bits_n (Int Int)
 Bits_n)
(declare-datatype IntermediateOracleState_Normal_pkg_Eval-forstep0 ((oracle-intermediate-state-return_Normal_pkg_Eval-forstep0_2 (oracle-intermediate-state-return_Normal_pkg_Eval-forstep0_2_rand Bits_n)
 (oracle-intermediate-state-return_Normal_pkg_Eval-forstep0_2_T (Array Int (Maybe Bits_n)
)
)
)
)
)
(declare-datatype IntermediatePackageInstanceState_Normal_pkg ((no-intermediate-package-instance-state_Normal_pkg)
 (intermediate-package-instance-state_Normal_pkg_Eval-forstep0 (intermediate-package-instance-state-get_Normal_pkg_Eval-forstep0 IntermediateOracleState_Normal_pkg_Eval-forstep0)
)
)
)
(declare-datatype State_Normal_pkg ((mk-state-Normal-pkg (state-Normal-pkg-T (Array Int (Maybe Bits_n)
 ...
 (state--intermediate-Normal-pkg IntermediatePackageInstanceState_Normal_pkg)
)
)
)
...
(declare-datatype Return_Normal_pkg_Eval-forstep0 ((mk-return-Normal-pkg-Eval-forstep0 (return-Normal-pkg-Eval-forstep0-state (Array Int CompositionState-Normal)
)
 (return-Normal-pkg-Eval-forstep0-state-length Int)
 (return-Normal-pkg-Eval-forstep0-value (Maybe Empty)
)
 (return-Normal-pkg-Eval-forstep0-is-abort Bool)
)
)
)
; Composition of Normal
(define-fun oracle-Normal-pkg-Eval-forstep0 ((__global_state (Array Int CompositionState-Normal)
)
 (__state_length Int)
)
 Return_Normal_pkg_Eval-forstep0 (let ((__self_state (composition-pkgstate-Normal-pkg (select __global_state __state_length)
)
)
)
 ...
 no-intermediate-package-instance-state_Normal_pkg)
)
)
 ...
 (mk-return-Normal-pkg-Eval-forstep0 __global_state __state_length (mk-some mk-empty)
 false)
)
)
)
...
(declare-fun __sample-rand-Shifted-Bits_n (Int Int)
 Bits_n)
(declare-datatype IntermediateOracleState_Shifted_pkg_Eval-range0-1 ((oracle-intermediate-state-return_Shifted_pkg_Eval-range0-1_1 (oracle-intermediate-state-return_Shifted_pkg_Eval-range0-1_1_rand Bits_n)
)
)
)
(declare-datatype IntermediateOracleState_Shifted_pkg_Eval-forstep1 ((oracle-intermediate-state-return_Shifted_pkg_Eval-forstep1_2 (oracle-intermediate-state-return_Shifted_pkg_Eval-forstep1_2_T (Array Int (Maybe Bits_n)
)
)
 (oracle-intermediate-state-return_Shifted_pkg_Eval-forstep1_2_rand Bits_n)
)
)
)
(declare-datatype IntermediatePackageInstanceState_Shifted_pkg ((no-intermediate-package-instance-state_Shifted_pkg)
 (intermediate-package-instance-state_Shifted_pkg_Eval-range0-1 (intermediate-package-instance-state-get_Shifted_pkg_Eval-range0-1 IntermediateOracleState_Shifted_pkg_Eval-range0-1)
)
 (intermediate-package-instance-state_Shifted_pkg_Eval-forstep1 (intermediate-package-instance-state-get_Shifted_pkg_Eval-forstep1 IntermediateOracleState_Shifted_pkg_Eval-forstep1)
)
)
)
(declare-datatype State_Shifted_pkg ((mk-state-Shifted-pkg (state-Shifted-pkg-T (Array Int (Maybe Bits_n)
 ...
 (state--intermediate-Shifted-pkg IntermediatePackageInstanceState_Shifted_pkg)
)
)
)
...
(declare-datatype Return_Shifted_pkg_Eval-range0-1 ((mk-return-Shifted-pkg-Eval-range0-1 (return-Shifted-pkg-Eval-range0-1-state (Array Int CompositionState-Shifted)
)
 (return-Shifted-pkg-Eval-range0-1-state-length Int)
 (return-Shifted-pkg-Eval-range0-1-value (Maybe Empty)
)
 (return-Shifted-pkg-Eval-range0-1-is-abort Bool)
)
)
)
(declare-datatype Return_Shifted_pkg_Eval-forstep1 ((mk-return-Shifted-pkg-Eval-forstep1 (return-Shifted-pkg-Eval-forstep1-state (Array Int CompositionState-Shifted)
)
 (return-Shifted-pkg-Eval-forstep1-state-length Int)
 (return-Shifted-pkg-Eval-forstep1-value (Maybe Empty)
)
 (return-Shifted-pkg-Eval-forstep1-is-abort Bool)
)
)
)
