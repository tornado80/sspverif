...
;;
(define-fun no-overwriting-prf ((prf <PackageState_PRF_<$<!true!><!n!>$>>))
  Bool
  (let ((kid (<pkg-state-PRF-<$<!true!><!n!>$>-kid_> prf))
        (LTK (<pkg-state-PRF-<$<!true!><!n!>$>-LTK> prf))
        (H (<pkg-state-PRF-<$<!true!><!n!>$>-H> prf)))
    (forall ((i Int))
            (and
...
(define-fun invariant
    ((state-H710  <GameState_H7_<$<!n!><!false!><!true!><!zeron!>$>>)
     (state-H711  <GameState_H7_<$<!n!><!true!><!true!><!zeron!>$>>))
  Bool
