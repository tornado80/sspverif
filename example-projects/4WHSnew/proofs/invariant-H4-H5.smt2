...
(define-fun invariant
  ...
  Bool
  (let ((gamestate-H4 (<game-H4-<$<!n!><!b!><!zeron!>$>-pkgstate-Game_nochecks> state-H4))
		(gamestate-H5 (<game-H5-<$<!n!><!b!><!zeron!>$>-pkgstate-Game_nokey> state-H5))
		(noncestate-H4 (<game-H4-<$<!n!><!b!><!zeron!>$>-pkgstate-Nonces> state-H4))
		(noncestate-H5 (<game-H5-<$<!n!><!b!><!zeron!>$>-pkgstate-Nonces> state-H5)))
  (and (= (<pkg-state-Nonces-<$<!true!><!n!>$>-Nonces> noncestate-H4)
		  (<pkg-state-Nonces-<$<!true!><!n!>$>-Nonces> noncestate-H5))
	   (= (<pkg-state-Game_nochecks-<$<!b!><!n!><!zeron!>$>-LTK> gamestate-H4)
		  (<pkg-state-Game_nokey-<$<!b!><!n!><!zeron!>$>-LTK>    gamestate-H5))
	   (= (<pkg-state-Game_nochecks-<$<!b!><!n!><!zeron!>$>-ctr_> gamestate-H4)
		  (<pkg-state-Game_nokey-<$<!b!><!n!><!zeron!>$>-ctr_>    gamestate-H5))
	   (= (<pkg-state-Game_nochecks-<$<!b!><!n!><!zeron!>$>-H> gamestate-H4)
		  (<pkg-state-Game_nokey-<$<!b!><!n!><!zeron!>$>-H>    gamestate-H5))
	   (= (<pkg-state-Game_nochecks-<$<!b!><!n!><!zeron!>$>-kid_> gamestate-H4)
		  (<pkg-state-Game_nokey-<$<!b!><!n!><!zeron!>$>-kid_>    gamestate-H5))
	   (= (<pkg-state-Game_nochecks-<$<!b!><!n!><!zeron!>$>-RevTested> gamestate-H4)
		  (<pkg-state-Game_nokey-<$<!b!><!n!><!zeron!>$>-RevTested>    gamestate-H5))
	   (= (<pkg-state-Game_nochecks-<$<!b!><!n!><!zeron!>$>-Fresh> gamestate-H4)
		  (<pkg-state-Game_nokey-<$<!b!><!n!><!zeron!>$>-Fresh>    gamestate-H5))
	   (= (<pkg-state-Game_nochecks-<$<!b!><!n!><!zeron!>$>-First> gamestate-H4)
		  (<pkg-state-Game_nokey-<$<!b!><!n!><!zeron!>$>-First>    gamestate-H5))
	   (= (<pkg-state-Game_nochecks-<$<!b!><!n!><!zeron!>$>-Second> gamestate-H4)
		  (<pkg-state-Game_nokey-<$<!b!><!n!><!zeron!>$>-Second>    gamestate-H5))

	   (let ((state-H4 (<pkg-state-Game_nochecks-<$<!b!><!n!><!zeron!>$>-State> gamestate-H4))
			 (state-H5 (<pkg-state-Game_nokey-<$<!b!><!n!><!zeron!>$>-State>    gamestate-H5)))
		 (state-equality state-H4 state-H5)))))
